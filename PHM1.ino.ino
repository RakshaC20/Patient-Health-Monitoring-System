...
#define DEBUG true
#define SSID "wifi name"     // "SSID-WiFiname"
...
String msg = "GET /update?key=PU5BJW9CHWSDXBFP"; 
...
void setup()
{
  ...
  // Double-check the "pulseSensor" object was created and "began" seeing a signal. 
   if (pulseSensor.begin()) {
    Serial.println("Patient Monitoring");  //This prints one time at Arduino power-up,  or on Arduino reset.  
  }
  Serial.println("AT");
  esp8266.println("AT");
